...
export default function Footer() {
  return (
    <footer className="bg-footer-grad text-white">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-sm text-[#E5E7EB] mb-8 leading-relaxed">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-akrive-grotesk font-bold text-xl mb-8 text-white uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Resources */}
          <div>
            <h3 className="font-akrive-grotesk font-bold text-xl mb-8 text-white uppercase tracking-wider">Resources</h3>
            <ul className="space-y-4">
              <li>
                <Link href="#" className="text-[#E5E7EB] hover:text-white transition-all duration-300 hover:translate-x-2 inline-block text-sm">
                  About Us
          ...
          {/* Contact */}
          <div>
            <h3 className="font-akrive-grotesk font-bold text-xl mb-8 text-white uppercase tracking-wider">Contact Us</h3>
            <ul className="space-y-5">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-3 text-[#9eb4d8] flex-shrink-0 mt-0.5" />
                <span className="text-[#E5E7EB] text-sm">Barrington House, Leake Rd, Costock, Loughborough LE12 6XA</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-3 text-[#9eb4d8] flex-shrink-0" />
                <Link href="tel:08453313031" className="text-[#E5E7EB] hover:text-white transition-colors">
                  0845 331 3031
                </Link>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-600/30 mt-16 pt-10 text-sm text-[#E5E7EB]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {new Date().getFullYear()} BoardChampions. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="#" className="text-[#E5E7EB] hover:text-white transition-all duration-300 border-b border-transparent hover:border-white pb-1">
                Privacy Policy
              </Link>
              <Link href="#" className="text-[#E5E7EB] hover:text-white transition-all duration-300 border-b border-transparent hover:border-white pb-1">
                Terms of Service
